  ...
  function TournamentCard({ t, onPlay, onRefresh }: TournamentCardProps) {
    ...
    const fetchRankings = useCallback(async () => {
      ...
      const { data } = await supabase
        .from('tournament_entries')
        .select('best_score, attempt_count, players(username, wallet_address, player_type)')
        .eq('tournament_id', t.id)
    ...
    return (
      <div style={{
        ...
        {/* Tab toggle: Actions / Leaderboard */}
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        background: isMe ? 'rgba(124,58,237,0.15)' : 'rgba(10,6,20,0.6)',
                        border: isMe ? '1px solid rgba(124,58,237,0.5)' : '1px solid rgba(124,58,237,0.1)',
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: 11, color: isMe ? '#a78bfa' : '#e2d9f3', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
      ...
      <div style={{ height: '100%', overflowY: 'auto', padding: 16 }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {tournaments.map(t => (
              <TournamentCard key={t.id} t={t} onPlay={onPlay} onRefresh={fetchTournaments} />
            ))}
          </div>
        )}
      </div>
